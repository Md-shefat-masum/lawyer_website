    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="">
                    <div class="card-body">
                        <form action="{{ route('admin_descriptive_about_update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form_content">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-8">
                                            ...
                                            <input type="file" name="banner" class="form-control" placeholder="image" value="{{ old('image') }}">
                                        </div>
                                        <div class="col-4">
                                            <img src="{{ asset(''.$short_about->banner) }}" alt="image" style="height: 70px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <img src="{{ asset(''.$short_about->image) }}" alt="image" style="height: 70px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="" class="form-control description">{{ $short_about->description }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
