    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="">
                    <div class="card-body">
                        <form action="{{ route('admin_team_lead_update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form_content">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-8">
                                            <label for="input-1">Left Image</label> <span class="text-danger"></span>
                                            <input type="file" name="image" class="form-control" placeholder="image" value="">
                                        </div>
                                        <div class="col-4">
                                            <img src="{{ asset(''.$information->image) }}" alt="profile_pic" style="height: 70px">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
